...
const artworks = {
    ...
    2: {
        ...
        description: "fineliner, marker, colored pencil on 220 g/m2 terra vanilla paper, 21 cm x 29,7 cm",
        images: ["assets/images/artworks/2 Flora's Rakete.jpg", "assets/images/artworks/2.1 Flora's Rakete Detail.jpg"]
    },

    3: {
        title: "bliss",
        description: "fineliner, marker, colored pencil on 190 g/m2 white paper, 21 cm x 29,7 cm",
        images: ["assets/images/artworks/3 bliss.jpg", "assets/images/artworks/3.1 bliss Detail.jpg"]
    },
    4: {
        title: "Schmetterlingsgerüst",
        description: "fineliner, marker, colored pencil on 220 g/m2 terra vanilla paper, 21 cm x 29,7 cm",
        images: ["assets/images/artworks/4 Schmetterlingsgerüst.jpg", "assets/images/artworks/4.1 Schmetterlingsgerüst Detail.jpg"]
    },
    5: {
        title: "Federkreisel",
        description: "fineliner, marker, colored pencil on 220 g/m2 terra vanilla paper, 21 cm x 29,7 cm",
    ...
    7: {
        ...
        images: ["assets/images/artworks/7 göttliches Timing trifft Matcha Latte.jpg", "assets/images/artworks/7.1 göttliches Timing trifft Matcha Latte Detail.jpg"]
    },
        ...
        pieces: [
            {
                ...
                description: "acrylic paint, marker, colored pencil on plasterboard, 90 cm x 125 cm x 1,5 cm",
                images: ["assets/images/artworks/8 capricorn sun, libra moon, virgo rising 1:3.jpg", "assets/images/artworks/8.1 capricorn sun, libra moon, virgo rising 1:3 Detail.jpg"]
            },
            {
                title: "capricorn sun, libra moon, virgo rising 2/3",
                description: "acrylic paint, marker on plasterboard, 90 cm x 125 cm x 1,5 cm",
                images: ["assets/images/artworks/8.2 capricorn sun, libra moon, virgo rising 2:3.jpg", "assets/images/artworks/8.3 capricorn sun, libra moon, virgo rising 2:3 Detail.jpg"]
            },
            {
                title: "capricorn sun, libra moon, virgo rising 3/3",
                description: "acrylic paint, marker on plasterboard, 90 cm x 125 cm x 1,5 cm",
                images: ["assets/images/artworks/8.4 capricorn sun, libra moon, virgo rising 3:3.jpg", "assets/images/artworks/8.5 capricorn sun, libra moon, virgo rising 3:3 Detail.jpg"]
            }
        ]
    },
    ...
    13: {
        ...
        images: ["assets/images/artworks/13 I'm that ghost.jpg", "assets/images/artworks/13.1 I'm that ghost Detail.jpg"]
    },
    ...
    17: {
        ...
        description: "acrylic paint, marker on 410 g/m2 heavy cotton fabric, 100 cm x 100 cm x 3,8 cm",
     ...
     18: {
        ...
        description: "acrylic paint, marker on 300 g/m2 medium-weight linen, 80 cm x 100 cm x 4,5 cm",
    ...
    20: {
        ...
        description: "acrylic paint, marker on 410 g/m2 heavy cotton fabric, 120 cm x 120 cm x 3,8 cm",
...
if (artworks[artId] && !artworks[artId].special) {
    ...
    container.innerHTML = `
        ...
        <div class="art-images">
            ${art.images.map(img => `<img src="${img}">`).join("")}
        </div>
    `;
}
...
if (artworks[artId] && artworks[artId].special) {
    ...
    artworks[artId].pieces.forEach(piece => {
        ...
        container.innerHTML += `
            ...
            <div class="art-images">
                ${piece.images.map(img => `<img src="${img}">`).join("")}
            </div>
        `;
    });
}